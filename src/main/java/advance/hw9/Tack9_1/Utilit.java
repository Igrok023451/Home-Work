...
public class Utilit {
    ...
    public static advance.hw7.one.Worker partWorkerName(advance.hw7.one.Worker[] workers, String name) {
        if (workers == null) {
            System.out.println("Worker[] is null!!!");
            return null;
        } else {
    ...
    public static double workerSalary(advance.hw7.one.Worker[] workers) {
        double sum = 0;
        if (workers == null) {
            System.out.println("Worker[] is null!!!");
            return sum;
    ...
    public static double workerMaxSalary(advance.hw7.one.Worker[] workers) {
...
//    public static double managerMinSalary(advance.hw7.one.Manager[] managers) {
